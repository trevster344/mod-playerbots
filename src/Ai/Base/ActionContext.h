...
public:
    ActionContext()
    {
        ...
        creators["surface to breathe"] = &ActionContext::surface_to_breathe;
...
private:
    ...
    static Action* surface_to_breathe(PlayerbotAI* botAI) { return new SurfaceToBreatheAction(botAI); }
