...
bool PlayerbotAIConfig::Initialize()
{
    ...
    avoidDrowning = sConfigMgr->GetOption<bool>("AiPlayerbot.AvoidDrowning", true);
    surfaceAirThreshold = sConfigMgr->GetOption<float>("AiPlayerbot.SurfaceAirThreshold", 0.5f);
